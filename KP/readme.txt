В рамках курсового проекта разработал базу данных строительного магазина по следующим условиям задания:
...
Данная база данных содержит информацию о товарах разбитых по категориям, профиль клиентов, корзину, историю покупок, скидки, новинки